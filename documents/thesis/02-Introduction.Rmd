...
Biodiversity is characterized by three nested levels, from genes, through individuals and species, to ecosystems.
...
Tropical forest disturbances are increasingly under the influence of human activities [@Davidson2012; @Lewis2015].
...
although some survive and reproduce allowing the transfer of adaptation across species boundaries [@Runemark2019].
...
Consequently, syngameon are not necessarily a transitional stage before complete speciation but may be a successful evolutionary state *per se* [@Cannon2019a]. 
...
Individuals present variation in performance, phenotypes, and genes within the species.
...
Finally, @LeBagousse-Pinguet2014 assessed directly functional diversity within-species between 13.5 and 33.6% of total functional diversity in limestone grasslands.
...
For instance, the topography spatially drives water and nutrient distribution in tropical forest [@Ferry2010].
...
and are thus underlining the role of intraspecific variability in ecology [@chave_neutral_2004].
...
The Janzen-Connell hypothesis explain species coexistence and the maintenance of tropical diversity with the interactions of two effects: 
(i) dispersion from parents, with more likely dispersion at short than long distance, 
and (ii) distance and density-dependent survival of offsprings due to competition, pathogens, and herbivores, 
...
Beyond density-dependence, theories have explored the peculiar and paramount role of treefall and succession in natural tropical forests.
...
In particular, a tradeoff was identified between survival in shade and growth in established gaps [@Baraloto2005; @Herault2010].
...
but @Niklas2003 were able to size the annual reproductive biomass thanks to the two-thirds power of the aboveground biomass of standing trees.
...
Other studies revealed microgeographic change in genetic structure and diversity without identifying adaptations [@Jones2006; @Audigeos2013], including effect of topography [@Torroba-Balmori2017], logging [@Degen2006; @Leclerc2015] and forest gaps [@Scotti2015].
...
@Savolainen2006 were able to evidence a sympatric ecological speciation with species sympatry, sister relationships, reproductive isolation, and highly unlikely earlier allopatric phase.
...
European white oaks' species lack private haplotypes indicating extensive hybridisation [@Petit2002], but show unique ecological niches with regard to drought, cold, and alkaline-soils tolerance [@Cannon2019a; @Leroy2019]. 
...
The site is characterized by an average annual rainfall of 3041 mm and a mean air temperature of 25.71 °C, with marked seasonal variation [@Aguilos2018].
...
Weather and climate is continuously recorded thanks to an eddy tower [@Bonal2008].
...
Among others, climate has a strong impact on forest dynamics, with, for instance, drought resistance for species with high wood density and small stature [@Aubry-Kientz2015a].
...
Water availability [@Wagner2011; @Wagner2012] and forest gaps [@Herault2010] particularly drives tree growth.
...
*S. globulifera* is widespread from Guinea Bissau to Tanzania in African Paleotropics and from Mexico to Brazil in American Neotropics [@Budde2013].
...
*S. globulifera* shows fine-scale genetic structure with topography all around its distribution[@Torroba-Balmori2017].
...
We hypothesised individual genetic and phenotypic variability within and among species to promote local coexistence within species complexes through microgeographic adaptations and niche partitioning across topography and forest gap dynamics (Fig. \@ref(fig:phdscheme)).
