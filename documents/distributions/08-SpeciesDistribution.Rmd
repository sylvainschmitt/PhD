...
```{r posterior2_species, fig.cap="Model parameters posterior.", fig.width=10, fig.height=14}
...
```{stan Model_species, output.var="Model", echo=T, eval=F, cache=F}
functions {
