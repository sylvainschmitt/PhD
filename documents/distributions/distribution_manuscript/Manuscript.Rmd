---
title: Pervasive local-scale species niche differentiation with topography within widespread Neotropical tree syngameon
date: '`r Sys.Date()`'
output:
...
Tropical forests and more especially Neotropics shelter the highest level of biodiversity worldwide [@Gaston2000], already highlighted more than 40 years ago [@connell_diversity_1978]. Lowland Amazonia include 4962 known tree species over 810 genera [@TerSteege2013]. Many Neotropical genera are thus species rich and present higher level of genetic polyphormisms than species-poor genera, likely related to introgressions between sister species [@Caron2019]. Among this species-rich genera, several are qualified of species complexes because they share a large ammount of genetic variation due to a recent common ancestor and/or hybridization [@baraloto_using_2012-1]. In addition, species linked by hybridization form syngameons, generally non-randomly structured among plants [@Boecklen2017]. For instance, @Marques2014 revealed numerous hybridization events in co-occuring *Epindendrum* species resulting in parental species being more back-crossed than pure-bred. Intersepcific hybrids occurs in 40% of families and 16% of genera, and more often in species-rich taxa [@Whitney2010].
...
Simulations suggest that low hybridization success promote species-coexistence in the community [@Cannon2015b]. Syngameaon resulting from these hybridization might have a selective advantage, qualified of genomic mutalism, decreasing the risk of extinction of species within syngameon while increasing their local adaptation [@Cannon2015b].
...
Congeneric taxa have been suggested to present pervasive species-habitat associations with topography French Guiana [@Allie2015].
Nutrient-poor white-sand and clay forests specialist species are often found in the same genera in the Peruvian Amazon, and sister species edaphic specialization is promoted by herbivores [@Fine2004].
...
In the present study, we explored sister species distribution between and within species complexes along abiotic environment and biotic interactions. We took advantage of a long-term study site with more than  75000 censused and geolocalised individuals in a highly diverse tropical forest site located within the Guiana Shield in the Amazon Basin. The site encompasses a diversity of micro-habitats through topographic variation ranging from seasonally flooded bottomlands to drier plateaus [@Allie2015] and displays variation in tree crowding including canopy gaps and closed-canopy forest patches [@ferry2010higher]. Combining tree inventories and LiDAR-derived topographic data, we used multivariate Bayesian modelling to address the following questions: (1) how do biotic and abiotic environment influence species complexes distribution at local scale ? (2) how do biotic and abiotic environment influence sister species relative distribution within species complexes ? Based on ... [citation], we expected species complexes to be distributed all along topgraphy and thus widespread at local scale, but ... We hypothesized that both abiotic environment and tree neighbours shaped sister species relative distribution within species complexes, due to the pervasive habitat specialization along topography of several congeneric taxa [@Allie2015].
...
$$NCI_i = \int_{t_0} ^{2015} \sum _{j|\delta_{i,j}<20m} ^{J_{i,t}} DBH_{j,t} ^2 e^{-\frac{1}{4}\delta_{i,j}}.dt$$
