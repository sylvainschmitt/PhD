...
Lowland Amazonia include 4962 described tree species belonging to 810 genera, resulting in many species-rich genera. Numerous species-rich tree genera share a large amount of genetic variation due to a recent common ancestor and/or hybridization, forming species complexes. Despite species complexes key role to understand Neotropical diversification, and the importance of ecological niches exploitation in species complexes establishment, little is known about Neotropical species complexes distribution.

By taking advantage of a long-term study site in a hyperdiverse tropical forest of the Guiana Shield, we explored sister species distribution between and within species complexes along a diversity of micro-habitats varying both in abiotic environment and biotic interactions. Combining tree inventories and LiDAR-derived topographic data, we used a Bayesian modelling framework to test the role of topography and tree neighboring at different taxonomic scales on both species complexes distribution and sister-species relative distribution within species complexes.

Species complexes of Neotropical trees were widely spread across habitats at local-scale. But sister species showed pervasive niche differentiation along topographic position, water accumulation, and competition gradients within species complexes. If supported by ecological reproductive isolation of species and adaptive introgression at the complex level, our results suggest that both habitat specialisation of sister species and widespread distribution of species complexes might explain the success of these Neotropical species complex at the regional scale [@TerSteege2013].
...
Tropical forests and especially Neotropics shelter the highest level of biodiversity worldwide [@Gaston2000], as already highlighted by @connell_diversity_1978 more than 40 years ago. Lowland Amazonia include 4962 described tree species belonging to 810 genera [@TerSteege2013], resulting in many species-rich genera. Among Neotropical species-rich genera, many have been shown to include higher level of genetic polymorphisms than species-poor genera, likely related to introgressions between sister species [@Caron2019]. Indeed, interspecific hybrids occurs in 16% of genera, and more often in species-rich taxa [@Whitney2010]. Species sharing a large amount of genetic variation due to a recent common ancestor and/or hybridization are defined as species complexes. In addition, species forming a group of otherwise distinct species interconnected by limited gene exchange are called syngameon [@Suarez-Gonzalez2018]. Despite species complexes key role to understand Neotropical diversification [@Pinheiro2018], little is known about Neotropical species complexes [@baraloto_using_2012-1; @Levi2019a; @TerSteege2013].

Simulations suggest that low hybridization success promote species-coexistence in the community [@Cannon2015b]. Syngameons resulting from hybridization might have a selective advantage, decreasing the risk of extinction while increasing local adaptation of their distinct species [@Cannon2015b]. Consequently, syngameon are not necessarily a transitional or incipient phase of a process towards complete speciation [@Cannon2019a]. Both syngameon and species complexes can result from a gene flow due to hybridization between donor species. Hybrids are often sterile or less fertile than their parents, despite some survive and reproduce allowing the transfer of adaptive variance across species boundaries [@Runemark2019]. Similarly, species complexes can result from adaptive radiation following and hybrid swarm [@Seehausen2004]. Hybrid species or species complexes establishment require reproductive isolation against paternal or sister species. Novel ecological niches exploitation helps gaining extrinsic isolation barriers [@Runemark2019]. 

Neotropical congeneric species have been shown to present pervasive species-habitat associations with topography [@Allie2015], soil type [@Fine2004; @Esteves2013], fertility [@Fine2004], and light access [@Esteves2013]. Similarly in Europe, white oaks is a well known species complex with species ecological preferences, including drought, cold tolerance and adaptation to alkaline soils [@Cannon2019a]. Nevertheless, little is known about the ecological distribution of the Neotropical species complexes and the belonging species' ecological niches.

In the present study, we explored sister species distribution between and within species complexes along abiotic environment and biotic interactions. We took advantage of a long-term study site with more than 75000 censused and geolocalized individuals in a highly diverse tropical forest site located within the Guiana Shield in the Amazon Basin. The site encompasses a diversity of micro-habitats through topographic variation ranging from seasonally flooded bottomlands to drier plateaus [@Allie2015] and displays variation in tree crowding including canopy gaps and closed-canopy forest patches [@ferry2010higher]. Combining tree inventories and LiDAR-derived topographic data, we used Bayesian modelling to address the following questions: (1) how do biotic and abiotic environment influence species complexes distribution at local scale ? (2) how do biotic and abiotic environment influence sister species relative distribution within species complexes ? Based on the local abundance of species-rich genera [@Allie2016], we expected species complexes to be widespread at local scale spanning all topographic positions. We hypothesized that both abiotic environment and tree neighbours shaped sister species relative distribution within species complexes, due to the pervasive habitat specialization along topography of several congeneric taxa [@Allie2015].

# Material and Methods

## Study site

The study was conducted in the northernmost part of the Guiana Plateau region, at the Paracou field station. The site was characterized by an average of 3041 mm annual rainfall and mean air temperature of 25.71 °C. Old tropical forest with an exceptional richness (over 750 woody species) has developed among the succession of small hills of this area, rising to 10–40 m a.s.l. [@Gourlet-Fleury2004].

The site is made of 16 permanent plots (fifteen 6.25 ha plus one 25 ha) which have been censused (diameter at breast height > 10 cm) every 1-2 years for more than 35 years. Nine of the plots were logged and subjected to human-induced disturbance in 1986.
...
Species complex distribution was inferred by comparing species complex occurrences, considered as presence, against all occurrences of tree belonging to other species, considered as pseudo-absences. Species complex presences $Presence_{species~complex}$ was inferred with a logistic regression following a Bernoulli distribution (best model form tested, see supplementary material S2 and S3):
...
Species joint-distributions were inferred within species complexes with softmax regression following a conjugated Dirichlet Process and Multinomial distribution:
