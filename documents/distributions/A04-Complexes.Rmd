...
include_graphics("data/Iryanthera_Baraloto.png")
```
...
include_graphics("data/Symphonia_Baraloto.png")
```
...
include_graphics("data/Talisia_Baraloto.png")
```
