...
* if the variant is functional (in an open reading frame or not)
* if the variant is morphtoype-specific (effectively at juvenile stage)
* annotation

So what we need/can have is (if I try to summarize):

* functional non-synonymous and morphotype-specific variant (at least for juveniles)
* functional non-synonymous and non morphotype-specific variant 
* functional synonymous and morphotype-specific variant (at least for juveniles)
* functional synonymous and non morphotype-specific variant
* transcribed non-functional and morphotype-specific variant
* transcribed non-functional and non morphotype-specific variant
* untranslated regions for control **?UTR**
* plastid DNA
