...
```{r, echo=F}
include_graphics("./data/bayes.jpeg")
```
...
include_graphics("./data/gamma.png")
```
...
```{r, echo=F}
include_graphics("./data/beta.png")
```
...
```{r}
include_graphics("./data/stan.png")
```
...
```{r}
include_graphics("./data/greta.png")
```
