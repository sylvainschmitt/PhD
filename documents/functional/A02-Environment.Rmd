...
DEM correlated to relative elevation
Slope correlated to TRI
TWI anti correlated with a lot of indexes: DEM, relative elevation, slope, tri. Log form
...
--> faire l'acp dans un autre plan
