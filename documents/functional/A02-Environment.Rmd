...
Biotic descriptors included the Dawkins index [@Dawkins1958] and the neighborhood crowding index [NCI; @Uriarte2004]. Dawkins index was directly measured on the field and represents both individual position within canopy layers and abiotic light environment, and thus biotic asymmetric competition through tree neighborhood. NCI was calculated with following formula:
