...
```{r boxplotDawkinsDBH, fig.cap='Boxplot of Dawkins and DBH'  }
env %>%
  ...
  coord_flip()
```
Boxplot between Dawkins and DBH (figure \@ref(fig:boxplotDawkinsDBH)) display a strong correlation both variables. With higher DBH, Dawkins index is also higher, showing that light access and ontogeny are strongly linked.
...
=======
>>>>>>> df45cd1ea26e77ce2d20caffabd5e13d2353a2b5
```{r CompetitionMatrix}
# Data <- data %>% 
#   left_join(env) %>% 
