...
```{r dawkins, fig.cap='Diameter at breast height (DBH) and Dawkins index [@Dawkins1958] correlation. Box colors indicates the Dawkins index. DBH and Dawkins index correlation has been investigated by Anova. **** indicates a $p-value < 0.0001$. Letters indicate post-hoc groups investigated by Tukey Honest Significant Differences.'}
