...
*Symphonia globulifera* were collected over all plots of the station for abondance matters, whereas *Eschweilera clade Parvifolia* were sampled only non-disturbed plots. 838 trees were collected in total (Table \@ref(tab:Ndata). 
...
> **Because of Bayesian inferences matters, subsequent analysis will be constructed omitting competition effect**
...
The log likelihood was hardly interpretable (Figure \@ref(fig:loglikelihood) because all traits did not have the same dataset for the model inferences, thus, log likelihoods were computed with different numbers of terms and were intrinsically different. Yet, LDMC and CC which were the only ones to have the same dataset, revealed that the model fitted better LDMC than CC.

Rsquared table was computed to compare all traits (Table \@ref(tab:Rsquared)), and highlighted that the additive model explained well LDMC variations, whereas invSLA and LT fitted four time less well, and CC had an even lower value of Rsquared.
