---
title: Individual-tree leaf functional traits answer to species niche within Neotropical species complexes (Temporary)
...
$DBH$ showed a significant effect (with a $DBH_{90}$ > 10cm the recruitment value where we started sampling trees) on almost all traits from all species, indicating that when growing in diameter individuals tend to have thicker and smaller leaves with increased SLA, dry matter and chlorophyll content (Fig. \@ref(fig:DBH90)).

$DBH_{90}$ has globally low to no effect on LDMC with values between 9 and 47 cm.

* CC $DBH_{90}$ was around 10 cm for *E. sagotiana* and *E. coriacea*; between 20-40 cm for *E. decolorans*, *S. sp1*, *S. globulifera*, *E. wachenheimii*, *E. grandiflora*; and at 209 cm for *E. pedicellata*. In a nutshell ontogeny did not affect CC for *E. sagotiana* and *E. coriacea*; strongly affected *E. pedicellata* CC during its whole life (**is it not due to no sampling of the plateau ?**); and affected only new recruits CC between 10 and 40 cm for remaining species.
* LA $DBH_{90}$ was between 45 and 60 cm for *E. coriacea*, *S. globulifera* and *E. decolorans*; and between 100 and 260 cm for remaing species. In a nutshell ontogeny affected LA only for new recruits between 10 and 60 cm for *E. coriacea*, *S. globulifera*, but during the whole life for remaining species.
* SLA $DBH_{90}$ was between 30 and 40 cm for *E. sagotiana*, *E. grandiflora*, and *E. coriacea*; between 40 and 100 for *E. decolorans*, *S. sp1*,  and *S. globulifera* ; and above 100 for *E. wachenheimii* and *E. pedicellata*.
* LT $DBH_{90}$ was close to 10 cm for *E. coriacea*, above 100 cm for *E. pedicellata* and between 30 and 100 cm for remaing species.

**How to sum-up all those informations ?**

## TWI (Fig. \@ref(fig:TWI))

* All $\beta_{TWI}$ are negative for LA with an effect varying from -0.05 to -0.5 (ten fold)
* On the opposite all $\beta_{TWI}$  from remaining traits (CC, SLA, LDMC,)
...
# plotly::ggplotly(g)
# save(g, file = "./functional_save/predictions.Rdata")
```
