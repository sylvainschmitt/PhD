...
**Why those different ecological scales (species complexes, species, and individuals)...**
...
On the other hand, the second axis from the leaf traits' PCAs was more variable but was related positively or negatively to LA except within *Symphonia sp.1* species, in association with other variables depending on the ecological level (LDMC between complexes and within species, LT within *Symphonia* complex and species, and CC within *Eschweilera* complex and species). Finally, between and within species complexes LA and SLA were decoupled, but not within species itself, highlighting decoupled LA from the leaf economics spectrum at higher ecological scale. Leaf area was not included in the leaf economics spectrum [@Baraloto2010; @wright_worldwide_2004] but larger leaves can be associated to softer wood (similarly to what we found with *Symphonia globulifera* complex including wood traits) conferring a higher efficiency in water conductivity [@Santiago2004a] resulting in more competitive species with increased hydraulic vulnerability and thus relate to the wood economics spectrum [@chave_towards_2009].

**Next paragraph need more litterature support.**

Finally, between and within species complexes the two PCAs axes significantly segregated individuals between complexes and species respectively, but not within species itself. The first axis segregated more individuals between complexes or species with no overlap, except within *Eschweilera* complex where the second axis also segregated *E. sagotiana* from other species. Thus the second axis, besides its correlation with LA that we might relate to the wood economics spectrum, seemed to highlight complex and species differentiation. Consequently for (i) species complex, *Symphonia* and *Eschweilera* would differentiate with an ecological preference toward bigger leaves with increased dry matter for *Eschweilera*; whereas (ii) *Sympohnia globulifera* and *Symphonia sp.1* morphotype would differentiate with an ecological preference toward bigger and thicker leaves for *Sympohnia globulifera* and (iii) *Eschweilera* species would differentiate over CC and LA. Interestingly though, the ecological strategy responsible of individuals segregation between species within complex represented by PCAs' second axis is globally conserved within species themselves.
...
Consequently, we observed a main variation of individuals leaf functional traits along the leaf economics spectrum with a segregation of individuals between species and complexes on a second axis of strategy, that might be related to the wood economics spectrum through LA. It might be interpreted as a global variation of individual along an acquisitive-conservative trade-offs within and between species due to ontogeny, abiotic environment, or biotic interactions allowing a better stability of species existence ; while speciation would occur more along the wood economics spectrum to better cope with different hydraulic strategy within tropical rainforests. Still we should note that individual still segregate to a lesser level on the leaf economics spectrum.
...
* Constrained trade-offs leading to few ecological strategies, but less and less constrained when increasing _"ecological resolution"_ (i.e. from within species to between complexes)
* Acquisitive-conservative trade-off, so-called leaf economics spectrum, always included as the major ecological strategy for individuals at every ecological level
...
* Thus we can hypothesize that speciation may occur by fine-scale adaptation to hydraulic conditions with wood economics spectrum, whereas individuals may vary within species in terms of acquisitive versus conservative strategy depending on individual ontogeny, abiotic conditions and biotic interactions (besides the leaf economics spectrum participate to individuals segregation between species at a lesser level)
