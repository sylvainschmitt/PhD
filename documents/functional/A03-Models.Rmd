...
We used the Neighborhood Competition Index (NCI) to depict competition. NCI was calculated with following formula:
...
* $\alpha_{NCI}$ represents the effect of neighbors distance to the individual, lower $\alpha_{comp}$ enable to strengthen competition effects from trees farther to the individual i. $\alpha_{comp}$ will be computed with positive values;
