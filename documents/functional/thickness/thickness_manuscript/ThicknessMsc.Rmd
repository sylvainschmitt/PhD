...
Variance partitioning showed the importance of relative extractable water (REW) and tree diameter (DBH) in leaf thickness variation (Fig. \@ref(fig:varpart)).
...
```{r varpart, fig.cap="Variance partitioning of leaf thickness between REW (red), DBH (brown), species (green), individuals (blue), and residual variation (pink)."}
...
```{r pars}
load("../thickness_save/fits.Rdata")
broom::tidyMCMC(fits$rewdbhspeciesindividual, 
