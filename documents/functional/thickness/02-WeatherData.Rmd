...
dplyr::select(data, LT, T55, T30, Hr55, Hr30, Patm, windaspect, windspeed, rain, rainday, rainfivedays, vpd55, PET, rainfall, REW) %>% 
  na.omit() %>%
  cor() %>% 
...
autoplot(princomp(~ LT + T55 + T30 + Hr55 + Hr30 + Patm + windaspect + windspeed + rain + rainday + rainfivedays + vpd55 +  PET + REW + rainfall,
                  data = data, cor = T),
...
dplyr::select(data,
              ...
              T55, T30, Hr55, Hr30, Patm, windaspect, windspeed, rain, rainday, rainfivedays, vpd55, PET, rainfall, REW) %>% 
...
randomForest::randomForest(LT ~ T55 + T30 + Hr55 + Hr30 + Patm + windaspect + windspeed + rain + rainday + rainfivedays + vpd55 +  PET + REW + rainfall,
