...
```{r model, fig.height=10, fig.width=10, fig.cap='Caption. *Details.*'}
include_graphics("./subject4_images/PhD4.jpg")
```
...
* "Further progress on both the empirical and theoretical front should culminate in a more general integration of plasticity, intraspecific varia-tion, and rapid evolution into community ecology." [@Turcotte2016]
