...
PhD realized by Sylvain SCHMITT, entitled "Ecological genomics of niche exploitation and individual performance in tropical forest trees", specialized in ecology and evolution, started the 1st of September 2017 within UMR Biodiveristé Gènes et Communautés (BIOGECO), under the supervision of Bruno Hérault and Myriam Heuertz, under a doctoral contract (contrat doctoral) funded by a grant from the Ministry of Research (bourse du ministère de l'enseignement supérieur et de la recherche, MESR).
...
*Symphonia globulifera* (Clusiaceae) represents a species complex in French Guiana, comprising two weakly differentiated morphotype living in differentiated habitats: *S. globulifera* (sensu stricto) preferentially grows in valley bottoms experiencing seasonal flooding and *S. sp.1* exploit a variety of drier habitats along well-drained slopes and hilltops. We explored in detail habitat preference of the two morphotypes in the Paracou research station, highlighting topographic wetness index as a good predictor of the distribution of morphotypes (see figure \@ref(fig:allSympho)A). Between October and December, we sampled 402 adult trees for genome scan and functional trait analysis. We are using transcriptomic data of a transplantation (Tysklind et al, in prep) to design a sequence capture experiment (see figure \@ref(fig:allSympho)B). DNA from leaf samples is being currently extracted for the sequence capture. Preliminary, functional trait analysis of leaf and wood traits suggests weak morphotype differentiation (see figure \@ref(fig:allSympho)C). Further analysis from functional traits are realized for the master 2 thesis from Émilie Ducouret.

Next steps include:

* A sequence capture with leaf tissue from *Symphonia globulifera* sampling in Paracou
* An analysis of population genetic and environmental genomic on sampled individuals
* A potential extraction of *Symphonia globulifera* secondary metabolites from leaves collected in Paracou
...
* An analysis of association genetic for *Symphonia globulifera* traits, including leaf and wood functional traits, wood anatomical traits, potential leaf secondary metabolites and finally growth patterns.
...
* The further study of a second tree model (maybe *Eschweilera* genus
...
* Potential future participation to training course: "From genotypes to phenotypes - assessing forest tree diversity in the wild"
...
* Participation to the séminaire from Équipe génétique et écologie des populations of UMR Biodiveristé, Gènes et Communautés (BIOGECO) when present in Bordeaux
* Participation to genetic lab and UMR meetings from UMR Écologie des Forêts de Guyane (ECOFOG) when present in Kourou
...
* _Frequency of contacts with the co-directeur de thèse_: Every day when in Bordeaux or several time a month when in Kourou
...
* _General opinion on the PhD precising potential difficulties_: Positive opinion with no peculiar difficulties to be noticed except eventually difficulties due to distance (Bordeaux, Kourou, Yamoussoukro) easily solved by new technologies !
