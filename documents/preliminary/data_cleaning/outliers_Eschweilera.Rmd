...
* __P14-1-760__ all leaves, is a natural outlier identified in the PCA due to an anormally high SLA due to the fact that the sample comse from a tree rejection grown on a beheaded tree. Was removed from the datatable for further outliers detection and analysis.
* __13-2-881__ seemed to be offset on the PCA, but after checking value all traits were in a normal range except for the CC. Leaves sampled seemed to be young ones and wich could explain low SPAD values.
* __16-3-260__ seemed to be offset on the PCA, what could be due to abnormal values of LDMC and SLA. We discovered spurious value of dry weight that were repeated and corrected.
* __16-7-185-5__ have a particularly high SLA regarding other leaves of the same individual. LA values were badly attributed regarding leaves scan. Subsequently, LA data table has been corrected and updated.
