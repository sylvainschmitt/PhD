...
Genomic DNA was extracted from dried leaf tissue with a CTAB protocol described by @Doyle1987 and libraries were prepared using the NEBNext Ultra II FS DNA Library Prep kit (new England Biolabs Inc, UK), before pooling in equimolar amounts to be captured by hybridization. 
