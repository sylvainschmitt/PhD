...
load("../symcapture_save/growthData.Rdata")
growth <- stan_model("../symcapture_models/Growth.stan")
fit <- sampling(growth, chains = 1, data = mdata$mdata, save_warmup = F,
                     control = list(adapt_delta = 0.99, max_treedepth = 12))
save(fit, file = paste0("../symcapture_save/growth", chain, ".Rdata"))
