...
save(hi.index, file = file.path("symcapture_save", "introgress.Rdata"))
```

```{r introgress, fig.cap="Fraction of the genome inherited from S. globulifera for each individual (hybrid index or admixture coefficient). In this case, individuals are sorted by increasing hybrid index."}
