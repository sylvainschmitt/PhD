...
bamFolder=referenceMappingAll/bam
java -Xmx4g -jar $PICARD CreateSequenceDictionary R=referenceMappingAll/reference.fasta O=referenceMappingAll/reference.dict
samtools faidx referenceMappingAll/reference.fasta
for file in $(ls referenceMappingAll/bam/*.bam) # bam
do
  filename=$(basename "$file")
  filename="${filename%.*}"
  gatk --java-options "-Xmx4G" HaplotypeCaller \ 
    -R referenceMappingAll/reference.fasta \ 
    -I referenceMappingAll/bam/$file \  
    -O haplotypeCall/$filename.g.vcf.gz \
    -ERC GVCF
done
```
