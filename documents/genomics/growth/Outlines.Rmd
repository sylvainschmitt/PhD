...
**Forest gap dynamics have a strong impact on tree ecology, triggering a wide variety of demographic responses depending on functional strategies of individuals and species.**
**Traditionally, demographic responses to forest gap dynamics have been studied between species, neglecting genetic variability within species.**
**However, overlapping generations can maintain the genetic variation necessary for strong temporally variable selection to act on specific life stages.**
**Here we provide evidence that mature-forest species can grow in a diversity of successional niches thanks to genotypic adaptations to fine spatio-temporal dynamics of forest gaps, which decreases the overall risk of a stochastic local extinction.**
