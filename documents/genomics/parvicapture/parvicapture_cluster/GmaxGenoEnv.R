...
model <- stan_model("../parvicapture_models/GmaxGenoEnv.stan")
if(!file.exists("../parvicapture_save/GmaxGenoEnv")) stop("Saving folder doesn't exist.")
fit <- sampling(model, chains = 1, data = mdata, save_warmup = F,
                     control = list(adapt_delta = 0.99, max_treedepth = 12))
save(fit, file = paste0("../parvicapture_save/GmaxGenoEnv/GmaxGeno", chain, ".Rdata"))
