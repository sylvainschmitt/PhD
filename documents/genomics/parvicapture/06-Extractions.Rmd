...
Purification resulting in variable concentration not linear with input (Figure \@ref(fig:purification)), we dosed again all samples by NanoDrop and adjusted the estimate by Qubit as concentration were low (Figure ).

## Concentration

Concentration being low, we concentrated samples by SpeedVac to a minimum of 20 $ng. \mu L ^{-1}$. It means X time reduction (from 39 $\mu L$ to XX $\mu L$).

## Library test

We tested library preparation on 2 samples...
