...
g <- alignment %>% 
  ...
  ggtitle("N = 54", "too few we need to reduce transcript minimum size and/or minimum coverage.")
...
hmmscan --cpu 4 --domtblout pfam.domtblout ~/Tools/Trinotate/admin/Pfam-A.hmm Essago.filtered.fasta.transdecoder_dir/longest_orfs.pep
blastp -query Essago.filtered.fasta.transdecoder_dir/l
ongest_orfs.pep -db ~/Tools/UniProt/uniprot_sprot.fasta -max_target_seqs 1 -outfmt 6 -evalue 1e-5 -num_threads 10 > blastp.outfmt6
...
<!-- /java -jar ~/Tools/genomeview/genomeview.jar ../Essago.filtered.fasta Essago.filtered.fasta.transdecoder.bed -->
