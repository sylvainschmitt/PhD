...
* 19 973 transcripts with single-match
...
alignmentFiltered %>%
  ...
  ggtitle("N = 616", "too few we need to reduce transcript minimum size and/or minimum coverage.")
```
...
We detected 1530 ORFs on 1530 unique transcripts with `transdecoder` in previously selected transcripts, representing . Only, 469 included a start codon (Fig. \@ref(fig:orfFilterGraph)), which was too low and not retained as a filtering criterion.
