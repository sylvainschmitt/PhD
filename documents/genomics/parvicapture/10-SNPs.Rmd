...
individuals %>% 
  ...
  write_tsv(path = file.path(path, "Sequences", "calling", "Parvifolia.fam"), col_names = F)
```
...
g.het_imiss <- read_delim(file.path(pathCluster, "Sequences", "calling", "nonmissing",
