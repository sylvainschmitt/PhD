...
**Tab. S\@ref(tab:blindIdentification).** *Symphonia* second blind-identification
...
**Fig. S\@ref(fig:admixtureSympo).** *Symphonia* population structure using admixture

**Fig. S\@ref(fig:introgress).** *Symphonia* population structure using hybrid index 

**Fig. S\@ref(fig:bayescanOutliers).** Outlier SNPs among *Symphonia* species

**Fig. S\@ref(fig:conhetero).** Number of conspecific and congeneric neighbors

**Fig. S\@ref(fig:gnomFrac).** Distribution of derived or minor allele among species
