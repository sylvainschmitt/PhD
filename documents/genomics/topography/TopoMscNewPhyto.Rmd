...
Ecological niche; French Guiana; relative elevation; syngameon; topographic wetness index; tropical forests
...
But the five thousand species of trees botanically identified in Amazonia belong to only height hundreds and ten genera [@TerSteege2013],
...
For example, sister species of Californian plants have greater ecological and reproductive similarities than non-sister species, although most have observed at least one change in traits [@Anacker2014].
These niche and functional similarities are expected to lead to increased competition between closely-related tree species with a risk of local competitive exclusion, 
unless closely-related species increase their niche difference or decrease their fitness difference [@Turcotte2016],  
e.g. they become sufficiently different or similar [@Scheffer2006].
...
little is known of the eco-evolutionary forces that shape their ecological niches and allow their local coexistence.
...
With regard to local species coexistence, species complexes and syngeamons are especially susceptible to phylogenetic constraints due to their low level of genetic differentiation. 
However, species complexes and syngameons frequently include sympatric species coexisting at local scales [@Caron2019; @Gonzalez2009; @Cannon2019a].

To address local species coexistence in sympatry despite similar expected niches, 
niche theory evokes ecological niche differences [@lortie_rethinking_2004-1; @weiher_assembly_1995],
while emerging similarity theory evokes fitness convergence [@Scheffer2006; @Turcotte2016], 
that both limit competitive exclusion.
...
Therefore, fine-scaled mapped topography is a good candidate factor that may explain adaptation and local coexistence of closely-related species in Neotropical tree species complexes.
...
but each has a unique ecological niche regarding tolerance to drought, cold, and alkaline soils [@Cannon2019a; @Leroy2019]. 
...
1. How is the distribution of soil water and nutrients structured at fine spatial scale by the topographic gradient in which individuals grow?
...
following preliminary evidence of topography determining species’ ecological niches [Schmitt et al., in prep]. 
...
We designed in *silico* two sets of 20,000 80-mer probes for sequence capture, one for the *Symphonia globulifera*, and a second one compatible with both *Eschweilera sagotiana* and *Eschweilera coriacea* (Fig. S1, Fig. S2). 
...
*SNP calling and filtering in Symphonia*
...
We obtained 454,262 biallelic SNPs over 406 individuals without outgroups.
...
*SNP filtering for quantitative genomics in Symphonia*

This first dataset including 454,262 SNPs was used for population genetic analyses.
...
we specifically assessed the variation in organic matter, carbon, nitrogen and phosphorous content, exchangeable cation charge [@Soucemarianadin2004; @Roelens2007], water table depth [@Gourlet-Fleury2004], hydromorphy, and waterlogging [@Cantet2004].
...
The three gene pools correspond to the previously identified two morphotypes (70-80% of match), *S. globulifera* and *S. sp1*, 
...
*S. sp1* grows preferentially in drier plateaux and slopes (Schmitt et al., submitted) and has a light grey thin and smooth bark associated with smaller leaves, flowers, and fruits (Fig. \@ref(fig:symphospecies)b). 
*S. globulifera type Paracou* grows in wet habitats of bottomlands, but drier than those of *S. globulifera type Régina*, and has a dark bark that is intermediate between that of the other morphotypes with respect to thickness and rugosity (Fig. \@ref(fig:symphospecies)b). 
*S. globulifera type Régina* grows in the wettest bottomlands of Paracou and has a thick and lashed bark (Fig. \@ref(fig:symphospecies)b).
...
Among the three populations, 25 individuals (7%) showed patterns of introgression, 15 between *S. globulifera type Regina* and *S. sp1* and 10 between *S. globulifera type Paracou* and *S. sp1* (confirmed with `introgress` R package, Fig. S8). 
...
and fixed markers were enriched in the gene ontology term “response to water deprivation” ($p=0.01106$). 
...
captured through relative elevation, and avoid the wettest, hydromorphic habitats.
...
while additional factors contribute niche differentiation or phenotypic convergence among *Eschweilera* species.
Consequently, species adaptations to different characteristics of topography stabilize local coexistence through avoidance of competition among closely-related species within the two tree species complexes.
...
For the purpose of the study, we named the three species *S. sp1*, *S. globulifera type Paracou* and *S. globulifera type Régina* in reference to already existing morphotypes and local names.
The three species showed a low but significant genetic differentiation ($F_{ST} = 0.15$), 
as shown previously at the local scale between the two previously recognized morphotypes, *S. globulifera sensu stricto* and *S. sp1* [$F_{ST} = 0.114$ for genic SSRs; @Olsson2017].
...
Topography has already shown to be a driver of the distribution of the two previously recognized morphotypes [@Allie2015] with *S. globulifera* growing in low-elevation and wet bottomlands and *S. sp1* growing in drier slopes and plateaux.
...
Similar ecotypic differentiation with a designated swamp ecotype has been suggested in Africa [@Budde2013].
 Individual topographic conditions where individuals grow was mainly non-related to genetics, i.e. plastic (54-56% of residual variation) but among the remaining genetic variation the majority (80-85%) was due to species differences (Fig. \@ref(fig:SpDistVar)).
Thus, finescale topographic variation among individuals was driven by species adaptations, revealing local adaptation to topography among the three species at the hectare-scale.
Further studies at a broader regional scale are needed, but our results advocate for the definition of three distinct taxonomic species with differences in morphology (Fig. \@ref(fig:symphomorphotypes)), habitat preference (Fig. \@ref(fig:SpDistVar)), functional traits and growth trajectories (S. Schmitt pers. com.).

## Three species of *Eschweilera* adapted to soil chemistry coexist in sympatry

*Eschweilera* species avoided hydromorphs soils and were differentially adapted to soil chemistry. 
...
*E. coriacea* preferentially grows in fertile and phosphorus-rich valley bottoms but has a broad topographic niche, 
and *E. sagotiana* and *E. decolorans* preferentially exploit slopes and plateaus, 
characterized by low waterlogging and soil rich in soil organic compounds [Fig. \@ref(fig:SpDistVar); @Allie2015].
Topography, through iron oxides dissolution, litter- and tree-fall transfers and waterlogging, shape soil nutrient distribution in tropical forests [@Levins1971; @Ferry2010]. 
...
The results of *Eschweilera* are in contrast to those of *Symphonia*, with more plasticity and stronger genotypic effects for topographic position in *Eschweilera* than in *Symphonia.*
Topography had globally a greater role among *Symphonia* species than among *Eschweilera* species (less residual variation).
*Eschweilera* species, despite similar morphology have a higher genetic differentiation than *Symphonia* species. 
*Eschweilera* species may thus have evolved differentiation along other ecological niches, e.g., related to root depth or light access [@Ruger2009].
But *Eschweilera* species may also coexist by a decrease in fitness differences among species across a shared niche  [@Turcotte2016], 
thanks to the phenotypic convergence allowed by increased genetic differentiation [@Tobias2014].
Whereas the less differentiated species of *Symphonia* probably did not diverge genetically enough to converge phenotypically.

Literature includes numerous examples of niche differentiation among closely-related species growing in sympatry, 
...
Ecological speciation induced by steep gradients, such as soil types or soil metal content [@Fine2004; @Paun2016],
could also occur at a finer scale in sympatry with progressive habitat variation. 
Moreover, it emphasizes the potential role of species complexes and syngameons in the origin and maintenance of Neotropical forest diversity.
...
**Figure \@ref(fig:soilpca).** Principal component analysis (PCA) of topographic wetness index (TWI), relative elevation (RE) with edaphic and hydrological properties. Edaphic and hydrological properties include organic matter (OM), carbon (C), nitrogen (N), exchangeable cation charge (C) [@Soucemarianadin2004; @Roelens2007], water table depth [WTD in cm, @Gourlet-Fleury2004], hydromorphy and waterlogging [waterlog in 5 classes, @Cantet2004]). Data have been obtained by interpolating soil sampling with LiDAR data.
