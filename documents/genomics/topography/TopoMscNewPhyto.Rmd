...
gr.legend <- cowplot::get_legend(lapply(fitEnv, mcmc_intervals_data, regex_pars = c("Vp", "Vg", "Vr")) %>%
  ...
  theme(axis.title.x = element_blank(), axis.title.y = element_blank(),
        ...
        legend.position = "bottom", strip.text = element_text(face = "italic", size = 4)) +
...
cowplot::plot_grid(densities$g[[3]], 
                   bars$g[[4]], 
                   densities$g[[4]], 
                   bars$g[[3]],
                   densities$g[[1]], 
                   ...
                   g.white,
                   gr.legend,
                   nrow = 3, rel_widths = c(4,2,4,2), rel_heights = c(3,3,2),
                   labels = c("(a)", "", "(b)", "", "(c)", "", "(d)", "")) 
