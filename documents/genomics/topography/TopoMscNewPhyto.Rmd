...
*S. globulifera type Regina* grows in the wettest bottomlands of Paracou and has a thick and lashed bark (Fig. \@ref(fig:symphospecies)b ; Schmitt, pers. com.).
...
Genomic scans for *Symphonia* revealed fixed markers among populations (5.7% of SNPs, Fig. S9),
...
Relative elevation (RE) was related to the distribution of nutrients, opposing soils with the lowest degree of waterlogging (waterlog1) and increased soil fertility (soil carbon, nitrogen, organic matter, exchangeable cation charge) to those with intermediate levels of waterlogging and reduced soil fertility (Fig. \@ref(fig:soilpca)).
...
The spatial distribution of *Symphonia* species was driven by both topographic wetness index (TWI, Fig. \@ref(fig:SpDistVar)**c**, Tab. \@ref(tab:fits)), especially between *S. globulifera Regina* and *S. globulifera Paracou*, and relative elevation (RE, Fig. \@ref(fig:SpDistVar)**d**, Tab. \@ref(tab:fits)), especially between *S. sp1* and the two remaining species.
...
Here, we show that within tree species complexes, closely-related species have different realized optima for topographic niches and we provide evidence for genetic adaptations of species and of genotypes within species.
...
Conversely, *Eschweilera* species are differentially adapted to soil chemistry shaped by hydromorphy, avoiding the wettest habitats.
The greater role of topographic position among *Symphonia* species than among *Eschweilera* species suggests that topography may be the main factor in differentiating niches among *Symphonia* species, while other factors may differentiate niches among *Eschweilera* species.
...
## Differentiation of *Symphonia* and *Eschweilera* species along topography: water and nutrients distributions

*Symphonia* species were differentially adapted to water and nutrients distributions with topographic wetness and relative elevation; whereas *Eschweilera* species were differentially adapted to soil chemistry due to hydromorphy.
...
Indeed, topographic wetness was more related to hydrology with water distribution; 
whereas relative elevation was more related to soil chemistry with nutrients distributions.
...
read_tsv("figures/soil.tsv") %>%
  na.omit() %>% 
  dplyr::select(-Refus, -C_N, -Mg_ech, -K_ech, -Polsen, -S, -TS, -Na_ech, -Al_KCl, -PBray2) %>% 
  dplyr::rename(TWI = wetness, RE = relele, OM = MO,
  ...
  autoplot(prcomp(., scale = T), 
           ...
           alpha = 0.3,
           loadings = T,
           loadings.colour = c('black', 'black', rep('grey', 13)),
           loadings.label.colour = c('black', 'black', 'blue', 'red', 'red', 
                                     'red', 'red', 'red', 'red', 
                                     'red', 'red', 'blue', 'blue', 'blue', 
                                     'blue'),
           loadings.label.fontface = c('bold', 'bold', rep('italic', 13)),
           loadings.label.size = c(6, 6, rep(4, 13)),
            loadings.label = T, 
