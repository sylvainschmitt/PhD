...
* 151 resequencing markers, ca. 180 bp each, on **192 individuals of Lecythidaceae** species from the Bertholletia clade. Includes ca. 130 nuclear markers, 10 cp DNA and 10 mitochondrial markers. Analysis currently conducted by Myriam Heuertz and Katharina Budde. Below are results of STRUCTURE cluster analysis for 40 individuals from Paracou and Piste de St. Elie (preliminary; some more individuals available in the complete dataset). It is visible that ***E. coriaceae*** contains four (!) discrete gene pools.  
